...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/f7f8e6eb-41d2-49b4-b0f1-e5520fb16bd7" with body:
    """
    {
      "owner": "System",
...
#    When I add "Accept" header equal to "application/json"
#    And I send a "GET" request to "/accesses/f7f8e6eb-41d2-49b4-b0f1-e5520fb16bd7"
#    Then the response status code should be 200
#    And the header "Content-Type" should be equal to "application/json; charset=utf-8"
#    And the response should be in JSON
#    And the JSON node "ownerUuid" should exist
#    And the JSON node "ownerUuid" should be equal to the string "8133db07-4ca2-4823-9ef5-4713c640cbd0"
...
#    And the JSON node "uuid" should be equal to the string "f7f8e6eb-41d2-49b4-b0f1-e5520fb16bd7"
