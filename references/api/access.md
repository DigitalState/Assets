...
| :--- | :--- | :---------- | :------ |
| Accept | string | The accepted returned content types. __Optional.__ Options: `application/json`, `application/ld+json`. Default: `application/ld+json` | `Accept: application/json` |
