    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            ...
            VALUES 
                ...
                (6, \'2b2ae71f-2e85-41c0-88f4-3161b0ca3eaa\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.authentication.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (7, \'e1b4933d-0a84-44bc-8b3a-67eed67e776c\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.identities.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (8, \'6e70bc1a-049c-4fa3-9f0c-b6e9a4c06f97\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.cases.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (9, \'279e1644-addb-48fd-983d-2a2be4aa8d89\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.services.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (10, \'c4bc767e-2772-4b27-8edb-8061b8cc1db3\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.records.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (11, \'90218efe-d6ff-4933-bc39-d0fe8ad85165\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.assets.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (12, \'2f047fec-f816-4c59-b2d1-b5b20bbc126b\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.cms.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (13, \'388c2861-7f4a-41b5-8a09-847833d32d66\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.camunda.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (14, \'aea7371f-7768-498e-be8d-68810be03111\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.formio.host\', \'127.0.0.1\', 1, 1, now(), now());
        ');
